...
(const Json::Value& question_jv)
{
  ...
  as_latitude = answer.latitude;
  as_longitude = answer.longitude;
  ...
  if (lon_decimal_pos != std::string::npos && lon_decimal_pos + 2 < longitude_str.length() -1) {
    longitude_str = longitude_str.substr(0, lon_decimal_pos +2);
      ...
      std::cout << "{"<<std::endl;
      std::cout << "\"identity\" : " << id_str  <<std::endl;
      std::cout << "\"latitude\" : "<< answer.latitude << std::endl;
      std::cout << "\"longitude\" : "<< answer.longitude << std::endl;
      std::cout << "}"<<std::endl;
      
      result["identity"] = id_str;    
